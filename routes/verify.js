...
app.get('/login-success', (req, res) => {
  ...
  res.send('Login Successful! Go to the verify letter page.<a href="/verify-letter">Verify Letter</a>');
});
...
app.post('/upload-letter', upload.single('letter'), (req, res) => {
    ...
    const mailOptions = {
      from: userEmail,  // Update with your Gmail address
      to: 'contact.nebulaapparel@gmail.com',
      subject: 'New Letter Uploaded',
      text: 'A new letter has been uploaded by ' + userEmail + '. Please verify it.',attachments:
         [
        {
